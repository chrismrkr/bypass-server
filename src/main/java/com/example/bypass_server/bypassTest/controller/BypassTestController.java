...
public class BypassTestController {
    ...
    public BypassTestResponseDTO queuedEventHandler(@RequestBody BypassTestRequestDto requestDto) {
        queuedEventTestService.testMethod(requestDto.getKey(), requestDto.getMsg());
        return null;
    }
